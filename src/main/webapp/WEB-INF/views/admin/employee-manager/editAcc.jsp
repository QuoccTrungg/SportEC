...
<form:form action="admin/editAcc.htm" modelAttribute="taikhoan">
			...
			<div class="row">
				...
				<div class="col-md-5 border-right">
					<div class="p-3 py-5">
						...
						<div class="row mt-3">
						<form:hidden path="nhanvien.MANV"/>
						<div class="col-md-12">
								<label class="labels">TK</label>
								<form:input path="TK" type="text"
									class="form-control" placeholder="TK" readonly="true"/>
									<form:errors path="TK"/>
							</div>
							<div class="col-md-12">
								<label class="labels">MK</label>
								<form:input path="MK" class="form-control" type="password" placeholder="Password" value="" />
									<form:errors path="MK"/>
							</div>
							<div class="col-md-12">

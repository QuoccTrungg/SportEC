...
<div class="dashboard-header">
	...
	<nav class="navbar navbar-expand-lg bg-white fixed-top">
		<a class="navbar-brand" href="admin.htm">Sport Equipment Shop</a>
				...
				<ul class="navbar-nav flex-column">
					<li class="nav-divider">Menu</li>
						...
						data-target="#submenu-5" aria-controls="submenu-5"><i
							class="fas fa-fw fa-table"></i>User Manager</a>
						<div id="submenu-5" class="collapse submenu" style="">
							<ul class="nav flex-column">
								<li class="nav-item">
									<a class="nav-link" href="admin/employee_info.htm">Employee Manager</a>
								</li>
					...
					<!-- <li class="nav-item"><a class="nav-link"  href="admin.htm"
						...
						<div id="submenu-5" class="collapse submenu" style="">
							<ul class="nav flex-column">
								<li class="nav-item"><a class="nav-link"  href="admin/employee_info.htm"
									data-toggle="collapse" aria-expanded="false"
									data-target="#submenu-5-1" aria-controls="submenu-5-1">Employee Manager</a>
									<div id="submenu-5-1" class="collapse submenu" style="">
										<ul class="nav flex-column">
											<li class="nav-item"><a class="nav-link"
												href="admin/employee_info.htm">Personal Information</a></li>
											<li class="nav-item"><a class="nav-link"
												href="admin/employee_acc.htm">Employee Account</a></li>
										</ul>
									</div>
								</li>
								<li class="nav-item"><a class="nav-link"  href="admin.htm"
									data-toggle="collapse" aria-expanded="false"
									data-target="#submenu-5-2" aria-controls="submenu-5-2">Customer Manager</a>
									<div id="submenu-5-2" class="collapse submenu" style="">
										<ul class="nav flex-column">
											<li class="nav-item"><a class="nav-link"
												href="admin/manager_customer.htm">Personal Information</a></li>
											<li class="nav-item"><a class="nav-link"
												href="admin/emloyee_manager.htm">Customer Account</a></li>
										</ul>
									</div>
								</li>
							</ul>
					...
					<li class="nav-item"><a class="nav-link" href="#"
						...
						<div id="submenu-8" class="collapse submenu" style="">
							<ul class="nav flex-column">
								<li class="nav-item"><a class="nav-link" href="admin/category_manager.htm"
					...
					<li class="nav-item"><a class="nav-link" href="#"
						...
						<div id="submenu-6" class="collapse submenu" style="">
							<ul class="nav flex-column">
								<li class="nav-item"><a class="nav-link" href="admin/product_manager.htm"
